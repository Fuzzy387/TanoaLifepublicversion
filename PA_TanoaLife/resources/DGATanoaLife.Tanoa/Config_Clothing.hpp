...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_B_GEN_Soldier_F", "Patrol Uniform", 0, { "", "", -1 } },
            { "U_B_GEN_Commander_F", "Command Patrol Uniform", 0, { "life_coplevel", "SCALAR", 7 } }, 
            { "U_B_T_Soldier_F", "Special Operations Uniform", 0, { "life_coplevel", "SCALAR", 6 } } //For Raids. To be discussed
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_police", "", 0, { "life_coplevel", "SCALAR", 1 } },
            { "H_HelmetB_black", "", 0, { "life_coplevel", "SCALAR", 4 } },
            { "H_HelmetB_tna_F", "Special Operations Helmet [Light]", 0, { "life_coplevel", "SCALAR", 6 } },
            { "H_HelmetB_Enh_tna_F", "Special Operations Helmet", 0, { "life_coplevel", "SCALAR", 8 } }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, { "", "", -1 } },
            { "G_Shades_Black", "", 0, { "", "", -1 } },
        ...
        vests[] = {
			...
			{ "V_PlateCarrier1_tna_F", "Special Operations Vest [Light]", 0, { "life_coplevel", "SCALAR", 7 } },
			{ "V_PlateCarrier2_blk", "", 0, { "life_coplevel", "SCALAR", 5 } },
			{ "V_PlateCarrier2_tna_F", "Special Operations Vest", 0, { "life_coplevel", "SCALAR", 7 } }
        ...
        backpacks[] = {
            ...
            { "B_Bergen_sgg", "", 0, { "", "", -1 } },
            { "B_Carryall_cbr", "", 0, { "", "", -1 } },
            { "B_ViperHarness_blk_F", "", 0, { "", "", 4 } },
            { "B_ViperHarness_oli_F", "Special Operations Backpack", 0, { "life_coplevel", "SCALAR", 6 } }
        };
    };
    ...
    class med_clothing {
        ...
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "", "", -1 } },
            { "U_Rangemaster", "Off Duty", 0, { "", "", -1 } },
			{ "U_C_Scientist", "On Duty", 0, { "", "", -1 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_blu", "", 10, { "", "", -1 } },
    ...
    class reb {
        ...
        uniforms[] = {
            ...
            { "U_I_G_resistanceLeader_F", "", 1100, { "", "", -1 } },
            { "U_O_SpecopsUniform_ocamo", "", 1700, { "", "", -1 } },
            { "U_O_PilotCoveralls", "", 1561, { "", "", -1 } },
            { "U_IG_leader", "Guerilla Leader", 1540, { "", "", -1 } },
