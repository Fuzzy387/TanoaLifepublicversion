...
switch (_side) do
{
	case west:
	{
		_return = [
			...
			["cop_spawn_3","Omuéré HQ","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
	...
	case civilian:
	{
		_return = [
			...
			["civ_spawn_3","Omuéré","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
	...
	case independent: {
		_return = [
			...
			["medic_spawn_2","La Rochelle Regional","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
			["medic_spawn_3","Omuéré Hospital","\a3\ui_f\data\map\MapControl\hospital_ca.paa"]
		];
	};
};
